...
Device (UAR2)
{
  ...
  Name (_CRS, ResourceTemplate () {
    ...
    // UART2_TX - EIM_D26 - GPIO3_IO26 - 90
    // UART2_RX - EIM_D27 - GPIO3_IO27 - 91
    // MsftFunctionConfig(Exclusive, PullUp, IMX_ALT4, "\\_SB.GPIO", 0, ResourceConsumer, ) { 90, 91 }
    // UART2_RTS - EIM_D28 - GPIO3_IO28 - 92
    // UART2_CTS - EIM_D29 - GPIO3_IO29 - 93
    //MsftFunctionConfig(Exclusive, PullUp, IMX_ALT4, "\\_SB.GPIO", 0, ResourceConsumer, ) { 92, 93 }
    //
    // MsftFunctionConfig (Arg0, Arg1, Arg2, Arg3, Arg4, Arg5, Arg6) { Pin List }
    VendorLong () {
      MSFT_UUID,            // Vendor UUID (MSFT UUID)
      ...
      RESOURCECONSUMER_EXCLUSIVE, // Flags (Arg5 | Arg0: ResourceConsumer | Exclusive)
      PULL_UP,              // Pin configuration (Arg1: PullUp)
      IMX_ALT4,0x00,        // Function Number (Arg2: IMX_ALT2)
      PIN_TABLE_OFFSET,     // Pin Table Offset (0x12)
      0x00,                 // Resource Source Index (Arg4: 0)
      ...
      0x00,0x00,            // Vendor Data Length (sizeof(Arg6) = 0)
      0x5a,0x00,0x5b,0x00,0x5c,0x00,0x5d,0x00,  // Pin List (90, 91, 92, 93)
      SB_GPIO               // Resource Name (Arg3: \_SB.GPIO in ASCII)
    }
...
Device (UAR5)
{
  ...
  Name (_CRS, ResourceTemplate () {
    ...
    // UART5_TX - CSI0_DAT14 - GPIO6_IO00 - 160
    // UART5_RX - CSI0_DAT15 - GPIO6_IO01 - 161
    // MsftFunctionConfig(Exclusive, PullUp, IMX_ALT3, "\\_SB.GPIO", 0, ResourceConsumer, ) { 160, 161 }
    //
    // MsftFunctionConfig (Arg0, Arg1, Arg2, Arg3, Arg4, Arg5, Arg6) { Pin List }
    VendorLong () {
      MSFT_UUID,            // Vendor UUID (MSFT UUID)
      ...
      0x20,0x00,            // Vendor Data Offset (0x12 + sizeof(PinList) + sizeof(ResourceName))
      0x00,0x00,            // Vendor Data Length (sizeof(Arg6) = 0)
      0xa0,0x00,0xa1,0x00,  // Pin List (160, 161)
      SB_GPIO               // Resource Name (Arg3: \_SB.GPIO in ASCII)
    }

    // UART5_RTS - CSI0_DAT18 - GPIO6_IO04 - 164
    // UART5_CTS - CSI0_DAT19 - GPIO6_IO05 - 166
    // MsftFunctionConfig(Exclusive, PullUp, IMX_ALT5, "\\_SB.GPIO", 0, ResourceConsumer, ) { 164, 165 }
    //
    // MsftFunctionConfig (Arg0, Arg1, Arg2, Arg3, Arg4, Arg5, Arg6) { Pin List }
    VendorLong () {
      MSFT_UUID,            // Vendor UUID (MSFT UUID)
      ...
      RESOURCECONSUMER_EXCLUSIVE, // Flags (Arg5 | Arg0: ResourceConsumer | Exclusive)
      PULL_UP,              // Pin configuration (Arg1: PullUp)
      IMX_ALT5,0x00,        // Function Number (Arg2: IMX_ALT4)
      PIN_TABLE_OFFSET,     // Pin Table Offset (0x12)
      0x00,                 // Resource Source Index (Arg4: 0)
      0x16,0x00,            // Resource Source Name Offset (0x12 + sizeof(PinList))
      0x20,0x00,            // Vendor Data Offset (0x12 + sizeof(PinList) + sizeof(ResourceName))
      0x00,0x00,            // Vendor Data Length (sizeof(Arg6) = 0)
      0xa4,0x00,0xa6,0x00,  // Pin List (164, 166)
      SB_GPIO               // Resource Name (Arg3: \_SB.GPIO in ASCII)
    }
